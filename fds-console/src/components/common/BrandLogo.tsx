        ...
        <svg viewBox="0 0 64 64">
          <defs>
            <linearGradient id={steelId} x1="11" y1="8" x2="53" y2="56" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#19a764" />
              <stop offset="0.55" stopColor="#008a45" />
              <stop offset="1" stopColor="#006b3a" />
            </linearGradient>
            <linearGradient id={hotId} x1="17" y1="13" x2="47" y2="53" gradientUnits="userSpaceOnUse">
              <stop offset="0" stopColor="#ffffff" />
              <stop offset="0.5" stopColor="#e7f6ef" />
              <stop offset="1" stopColor="#c9ead8" />
            </linearGradient>
          ...
          <path
            ...
            opacity="0.42"
          />
          <circle cx="32" cy="34.8" r="3.2" fill="#ffffff" />
          <circle cx="32" cy="34.8" r="7.2" fill="none" stroke="#c9ead8" strokeWidth="1.2" opacity="0.7" />
        </svg>
      </span>
